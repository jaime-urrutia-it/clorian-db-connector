...
/**
 * Detecta tickets de soporte en MySQL con status='Open' y sin jira_issue_key,
 * los crea en Jira como issues y guarda la clave devuelta en MySQL.
 */
public class SupportTicketSyncService {

    private final IssueCreator issueCreator;
    private final String customFieldId; // Ej: "customfield_10058" (hoy lo fija IssueCreator internamente)
